...
class TestSubtitleGenerator:
    ...
    def test_model_sizes(self):
        """Should map size presets to model IDs."""
    ...
    def test_to_srt_time(self):
        """Should convert seconds to SRT time format."""
        gen = SubtitleGenerator()
    ...
    def test_generate_creates_files(self, tmp_path, monkeypatch):
        """Should create SRT files for each chapter."""
        ...
        chapters = [
            {"audio_path": "/tmp/test.wav", "duration_s": 10.0},
        ]
